...
public class ImpParser extends Parser {
	...
	public static final int
		...
		T__9=10, T__10=11, OP=12, NUMBER=13, VAR=14, TYPE=15, ESPACOS=16;
	public static final int
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & 19778L) != 0 );
			setState(11);
			match(EOF);
			}
		}
	...
	public static class DecContext extends CommandContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImpVisitor ) return ((ImpVisitor<? extends T>)visitor).visitDec(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
